                ...
                <div class="col-xs-12 col-sm-7">
                    ...
                    <div class="rubrique clearfix">
                        ...
                        <div class="experience clearfix">
                            <div class="col-3">
                                <div class="lieu">Evoliz</div>
                                <div class="date">2023 (8 sem.)</div>
                            </div>
                            <div class="col-9">
                                <div class="profession">Developpeur Web</div>
                                <div class="details">
                                    <ul>
                                        <li>Ajout et amélioration de fonctionnalité de la solution Evoliz.</li>
                                        <li>Maintenance et correction de la solution Evoliz.</li>
                                        <li>Découverte du framework PHP Laravel et des methodes de développement avec pomodoro.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
